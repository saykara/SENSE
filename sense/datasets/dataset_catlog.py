...
FLYINGTHINGS3D_DIR= os.path.join('E:\Thesis', 'SceneFlow/FlyingThings3D_subset')
MONKAA_DIR=os.path.join('E:\Thesis', 'SceneFlow/Monkaa')
DRIVING_DIR=os.path.join('E:\Thesis', 'SceneFlow/Driving')
SINTEL_DIR=os.path.join('E:\Thesis', 'MPI_Sintel')
KITTI2012_DIR=os.path.join('E:\Thesis', 'KITTI_Stereo_2012')
KITTI2015_DIR=os.path.join('E:\Thesis', 'KITTI_scene_flow')
